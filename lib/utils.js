...
var key = "ticket";
var default_redirect_uri = window.location.origin + window.location.pathname;
...
function login() {
  var redirect_uri = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : default_redirect_uri;
